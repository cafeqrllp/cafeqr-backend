...
public class OrderDtoMapper {
    ...
    public OrderResponseDto toResponseDto(Order order) {
        ...
        return OrderResponseDto.builder()
                ...
                .creditCustomerName(order.getCustomerName() != null ? order.getCustomerName() : (order.getCustomers() != null && !order.getCustomers().isEmpty() ? order.getCustomers().get(0).getName() : null))
                .creditCustomerPhone(order.getCustomerPhone() != null ? order.getCustomerPhone() : (order.getCustomers() != null && !order.getCustomers().isEmpty() ? order.getCustomers().get(0).getPhone() : null))
