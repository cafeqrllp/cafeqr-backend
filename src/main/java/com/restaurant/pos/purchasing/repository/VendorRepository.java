...
public interface VendorRepository extends JpaRepository<Vendor, UUID> {
    ...
    @Query("SELECT v FROM Vendor v WHERE v.id = :id AND v.clientId = :clientId")
    Optional<Vendor> findByIdAndClientIdForUpdate(@Param("id") UUID id, @Param("clientId") UUID clientId);
